...
chrome.runtime.sendMessage({ type: 'XMLHttpRequest', request: { url: "https://github.com/gothictomato/cryptcoord/raw/master/SimpleDiscordCrypt.user.js" } }, (result) => { //or chrome.runtime.getURL("SimpleDiscordCrypt.user.js")
	let script = document.createElement('script');
	script.textContent = `
(()=>{
